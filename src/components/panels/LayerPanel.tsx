...
export const LayerPanel: React.FC<LayerPanelProps> = ({
  ...
  const canvasOptions = [
    ...
    { id: "drawing", name: "绘图", icon: "brush-outline" },
    { id: "content", name: "内容", icon: "text-outline" },
    { id: "control", name: "控制", icon: "settings-outline" },
  ];
          ...
          >
            ...
            <View style={styles.layerActions}>
              ...
              >
                <Ionicons
                  name={
                    visibleLayers[canvas.id] ? "eye-outline" : "eye-off-outline"
                  }
                  size={20}
                  color={
                    visibleLayers[canvas.id]
                      ? COLORS.accent
                      : COLORS.icon.inactive
                  }
                />
